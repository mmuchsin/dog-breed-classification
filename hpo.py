...
def train(model, data_loaders, criterion, optimizer, scheduler, dataset_sizes, device, num_epochs):
    """
...
def main(args):
    ...
    """
    model = train(model, data_loaders, criterion, optimizer, exp_lr_scheduler, dataset_sizes, device, args.epochs )

    """
    TODO: Test the model to see its accuracy
    """
    test(model, data_loaders["test"], criterion, device)
